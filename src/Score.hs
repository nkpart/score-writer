...
a24 = Score
  ...
  where p1 = Part [r16 & flam.accent <->l32<-> l32<-> r16 & dot<-> l16 & flam . cut ,r32<->l32<->l32<->r32<->l16&dot<->l16&cut.accent
                  ,triplet (r16<->l16<->r16&drag) <-> singles 4 r32, r8&roll<->triplet (l16<->r16<->l16)
                  ,r16 & flam.accent.dot <-> l16&cut <-> r16 & flam . dot <-> l16 & cut . flam, singles 4 r32 <-> r16<-> triplet (r16 & flam<-> l16<-> r16 & accent)
